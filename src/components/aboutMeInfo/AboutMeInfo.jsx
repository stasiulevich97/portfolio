        ...
        <div className='AboutMeInfo'  id='AboutMe_marker'>
            ...
            <div className='aboutMeBlockWrapper'>
                <div className='descriptionBlock'>
                    <p className='greeting'>Hi,my name is <span className='myName'>Anastasiia</span></p>
                    <p>I am from Ukraine, I am 26 years old and currently live in Poland.Completed front-end development courses at Step IT Academy.</p>
                </div>
